<template>
  <div id="viewer" ref="viewer">
    <div class="controls" v-show="true">
...
export default {
  ...
  async mounted() {
    window.webpackPublicPath =
      "https://rawgit.com/Ni55aN/three.js-configurator/master/dist/";
    let url =
      "https://rawgit.com/Ni55aN/three.js-configurator/master/dist/THREEConfigurator.js";
